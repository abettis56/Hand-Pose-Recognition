...
def train_autoencoder():
    ...
    normalization_factor = np.amax(formatted_data)
    # normalize data
    ...
    encode_layer = Dense(10, activation='selu')(input_img)

    # "encoded" is the encoded representation of the input
    encoded = Dense(encoding_dim, activation='selu')(encode_layer)

    # Hidden layer to help with expanding
    decode_layer = Dense(10, activation='selu')(encoded)

    # "decoded" is the lossy reconstruction of the input
    decoded = Dense(20, activation='selu')(decode_layer)
    ...
    decoder = Model(encoded_input, decoder_layer(autoencoder.layers[-2](encoded_input)))

    autoencoder.compile(optimizer='adadelta', loss='mean_squared_error')

    autoencoder.fit(formatted_data, formatted_data,
                epochs=300,
                batch_size=256,
                shuffle=False,
                validation_data=(formatted_data, formatted_data))
    
    encoded_pts = encoder.predict(formatted_data)
    ...
    print(normalization_factor * decoded_pts - normalization_factor * formatted_data)
